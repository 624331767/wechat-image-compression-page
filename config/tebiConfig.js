...
module.exports = {
  // 存储桶名称
  bucketName: process.env.TEBI_BUCKET_NAME,
  // 自定义域名（用于生成公开访问URL）
  customDomain: process.env.TEBI_CUSTOM_DOMAIN,
  // 访问密钥
  ...
  // 预签名URL过期时间（毫秒）
  expires: process.env.TEBI_EXPIRES,
  // 文件前缀，用于组织文件
  filePrefix: process.env.TEBI_FILE_PREFIX
};